...
class CodexDriver(_SweptDriver):
    ...
    def run_turn(self, session_key: str, prompt: str, spec: TurnSpec,
        ...
        from core.support.interrupt import is_interrupted, register_subprocess, unregister_subprocess
    ...
    def interrupt(self, session_key: str) -> None:
        pass  # no cross-turn process; in-turn stops ride core.support.interrupt
